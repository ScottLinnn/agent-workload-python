"""Script to deploy the RAG agent to Vertex AI Agent Engine."""
...
def prep_databases():
    ...
    print(
        f"Generating LanceDB Data directly in GCS at gs://{bucket_name}/{prefix}/adk_rag_agent_lancedb"
    )
    generate_mock_data()
...
async def main():
    ...
    print("Deploying rag_agent to Vertex AI Agent Engine...")
